...
public class Overflow_OpenTermsAndConditionsApplitools {
    ...
    @Test
    public void overflow_OpenTermsAndConditionsApplitools() {
        ...
        myAcc.openTermsAndConditionsLink();

        eyes.open(driver, "TMProperty", "ValidateTermsPage");
        eyes.checkWindow("TermsUI");
        eyes.close();
