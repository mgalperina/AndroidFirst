...
public class CancelRestoringProperty {
    ...
    @Test
    public void cancelRestoringProperty() {
        ...
        myAcc.cancelRestoreProperty();

        Assert.assertTrue(myAcc.isHiddenPropertyThere());

        System.out.println("The hidden property is still here");
