...
public class GoFromNavDrawerToSendAppFeedback {
    ...
    @Test
    public void goFromNavDrawerToSendAppFeedback() {
        ...
        navDrawer.openFeedbackScreenFromNavDrawer();

        Assert.assertTrue(navDrawer.isGmailOpen());
