...
public class GoFromNavDrawerToSearch {
    AppiumDriver driver;
    ...
    @Test
    public void goFromNavDrawerToSearch() {
        ...
        navDrawer.openSearchScreenFromNavDrawer();

        Assert.assertTrue(defaultScreen.isDefaultTabOpen());
